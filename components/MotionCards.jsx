        ...
        <section
            ...
            <div className="motion-card__cards-area">
                ...
                <div ref={containerRef} className="motion-card__floating-labels">
                    ...
                    <div className="motion-card__floating-label motion-card__floating-label--orange">
                        <p className="motion-card__floating-text">smart contract logic</p>
                    </div>
                    <div className="motion-card__floating-label motion-card__floating-label--red">
                        <p className="motion-card__floating-text">brutalist aesthetics</p>
                    </div>
                </div>
            </div>
            ...
            <div className="motion-card__footer-text">
                <p className="motion-card__description">
                    My name is <strong>Shajar Ali</strong>, and I’ve spent over 6 years at the
                    intersection of creative frontend engineering and blockchain
                    architecture. I build high-performance decentralized experiences
                    that bridge the gap between pixel-perfect design and complex Web3 logic.
                </p>
            </div>
        </section>
    );
