...
export default function Navbar({ forceTheme }) {
    useEffect(() => {
        ...
        // ② Start white (on-dark) — video is dark background unless forced light
        if (navbar) { 
            if (forceTheme === 'light') {
        ...
        const updateNavbarColor = () => {
            ...
            if (forceTheme === 'light') return; // Skip scroll logic if theme is forced
