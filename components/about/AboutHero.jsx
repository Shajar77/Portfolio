...
export default function AboutHero() {
    return (
        <section className="about-hero">
                ...
                <div className="about-hero__content">
                    <div className="about-hero__left">
                        <div className="about-hero__image-area">
                            <div className="about-hero__image-wrap">
                                <img src="/project-hero.jpeg" alt="Shajar Ali" className="about-hero__img" />
                            </div>
                            <div className="about-status-tag">AVAILABLE FOR FREELANCE</div>
                            <img src="/assets/Footer-Sticker SVG/footer-sticker-camera.svg" className="about-sticker about-sticker--camera wiggle-element" alt="" style={{ filter: 'invert(1)' }} />
                        </div>
                    </div>
                    ...
                    <div className="about-hero__right">
                        <h1 className="about-hero__title">
                            SHAJAR ALI
                            <img src="/assets/Footer-Sticker SVG/footer-sticker-smiley.svg" className="about-hero__smiley wiggle-element" alt="" />
                        </h1>
                        <div className="about-hero__intro">
                            <h2 className="about-hero__intro-text">
                                ...
                                <span className="about-intro__highlight">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 634 28" fill="none" className="about-intro__underline-svg">
            ...
            <div className="about-hero__bg-blob">
                <img src="/assets/Service SVG/Service-card-pink-SVG.svg" alt="" />
            </div>
            <div className="about-hero__bg-grid"></div>
        </section>
    );
}
